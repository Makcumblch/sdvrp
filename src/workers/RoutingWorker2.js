function RoutingWorker(){
    ...
    function CustomerExchange(State, transport){
        ...
        function A(v1_, client1_, i1_, v2_, client2_){
            State.y[v2_][client1_] += State.y[v1_][client1_]

            State.y[v1_][client2_] += State.y[v1_][client1_]
            State.y[v2_][client2_] -= State.y[v1_][client1_]
        ...
        if(v1 === v2){
            ...
            if(State.y[v1][client1] === State.y[v2][client2]){
                ...
                A(v1, client1, i1, v2, client2)
            }else{
                A(v2, client2, i2, v1, client1)
            }
